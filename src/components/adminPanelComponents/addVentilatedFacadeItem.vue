        ...
        async postData() {
            try {
                ...
                if (this.isFacade) {
                    ...
                    res = await fetch('http://localhost:8000/api/ventilatedfacadeitems', {
                        method: 'POST',
                        body: formData,
                        mode: 'cors'
                    })
                } else {
                    formData.append('exteriorDesignId', this.id)
                    formData.append('file', this.file);
                    res = await fetch('http://localhost:8000/api/exteriordesignitems', {
                        method: 'POST',
                        body: formData,
                        mode: 'cors'
                    })
